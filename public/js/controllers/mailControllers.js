...
mailView.controller('filesCtrl', ['$scope', 'messages', '$http', 'request', '$window', '$rootScope',
	function($scope, messages, $http, request, $window, $rootScope) {
...
mailView.controller('inboxCtrl', ['$scope', 'code', 'request', 'messages', '$filter', '$window', '$cookieStore',
	function($scope, code, request, messages, $filter, $window, $cookieStore) {
...
mailView.controller('readMailCtrl', ['$scope', 'messages',
	function($scope, messages) {
		$scope.readMail = messages.readMail;
	}
]);

mailView.controller('composeMailCtrl', ['$scope',
	function($scope) {

	}
]);

mailView.controller('noticeCtrl', ['$scope', 'notice',
